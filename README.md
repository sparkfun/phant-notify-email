...
# phant-notify-email [![Build Status](https://secure.travis-ci.org/sparkfun/phant-notify-email.png?branch=master)](http://travis-ci.org/sparkfun/phant-notify-email)
